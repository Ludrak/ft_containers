...
void unit_vector()
{
...

    {
        UNIT_START("vector member functions")
            UNIT_TEST("vector::vector(1)")
                LIB::vector<int> vector = LIB::vector<int>();
            
            UNIT_TEST("vector::vector(2)")
                const LIB::vector<SomeClass> const_vector = LIB::vector<SomeClass>((size_t)50, SomeClass(42));
...

    {
        UNIT_START("vector iterators")
            ...
            UNIT_TEST("vector::reverse_iterator()")
            ...
            UNIT_TEST("vector::const_iterator()")
            ...
            UNIT_TEST("vector::const_reverse_iterator()")
